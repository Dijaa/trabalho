    ...
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <div class="grid grid-cols-1 gap-4 mt-8">
            <div class="border border-gray-200 rounded p-4">
                <a href="<%=request.getContextPath()%>/authArea/files" class="text-indigo-600 hover:text-indigo-500">Visualizar
                    Documentos</a>
            </div>
            <div class="border border-gray-200 rounded p-4">
                <a href="<%=request.getContextPath()%>/authArea/files/myFiles.jsp" class="text-indigo-600 hover:text-indigo-500">Visualizar
                    Meus Documentos</a>
            </div>
            <% if (usuario.getTipo() == 1) { %>
            <div class="border border-gray-200 rounded p-4">
                <a href="<%=request.getContextPath()%>/authArea/files/toAprove.jsp"
